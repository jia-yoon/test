...
export default {
  ...
  methods: {
    ...
    read () {
      this.$axios.get('http://localhost:5000/jiavue-project-cb02d/us-central1/test')
        .then(r => {
    ...
    update () {
      this.$axios.put('http://localhost:5000/jiavue-project-cb02d/us-central1/test/12345')
        .then(r => {
    ...
    del () {
      this.$axios.delete('http://localhost:5000/jiavue-project-cb02d/us-central1/test/444555')
        .then(r => {
